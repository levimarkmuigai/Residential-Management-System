...
import { validateEmail, validateName, validateNumber, validatePassword, validateRole } from "./validation/userDetails.js";
...
signupForm.addEventListener('submit', (event) => {
  ...
  if (!isFirstNameValid || !isLastNameValid || !isEmailValid || !isNumberValid || !isRoleValid || !isPasswordValid) {
